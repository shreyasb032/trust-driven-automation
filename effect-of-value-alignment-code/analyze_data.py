    ...
    if PRINT_TRIALS:
        ...
        for i in range(num_simulations):
            ...
            for j in range(num_missions):
                ...
                # Initialize data
                table_data = [['prior', 'after_scan', 'threat', 'rec', 'action', 'health', 'time', 'trust-fb', 'trust-est', 'perf_act', 'perf_est', 'wh_mean']]
...
if __name__ =="__main__":
    ...
    parser.add_argument('--print-trials', type=bool, help='Flag to control whether to print the details of each trial in each simulation (default: False)', default=False)
