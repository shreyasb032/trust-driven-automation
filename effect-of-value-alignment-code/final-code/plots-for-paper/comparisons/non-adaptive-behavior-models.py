...
def main():
    ...
    parent_directory = path.join('..', '..', 'varying-weights', 'data', 'BoundedRational')
    ax = analyze(parent_directory, threat_level, color='tab:blue', behavior='BRD', marker='o', ax=None)

    parent_directory = path.join('..', '..', 'varying-weights', 'data', 'ReversePsychology')
    ax = analyze(parent_directory, threat_level, color='tab:orange', behavior='RP', marker='v', ax=ax)

    parent_directory = path.join('..', '..', 'varying-weights', 'data', 'OneStepOptimal')
