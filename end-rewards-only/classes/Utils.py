...
def add_mission_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--time-loss-cost', type=float, default=-10.,
                        help='the reward associated with losing time (default: -10.)')

    parser.add_argument('--threat-level', type=float, default=0.7,
                        help="the general level of threat in the mission (default: 0.7)")
...
def add_simulated_human_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--simulated-alpha0', type=float, default=60.,
                        help="alpha0 parameter of the simulated human's trust dynamics (default: 60.)")

    parser.add_argument('--simulated-beta0', type=float, default=60.,
                        help="beta0 parameter of the simulated human's trust dynamics (default: 60.)")

    parser.add_argument('--simulated-ws', type=float, default=10.,
                        help="ws parameter of the simulated human's trust dynamics (default: 10.)")

    parser.add_argument('--simulated-wf', type=float, default=20.,
                        help="wf parameter of the simulated human's trust dynamics (default: 20.)")
...
def add_model_human_args(parser: argparse.ArgumentParser):
    ...
    """
    parser.add_argument('--model-kappa', type=float, default=0.2,
                        help='the rationality coefficient of the human model (default: 0.2)')
    ...
    parser.add_argument('--model-alpha0', type=float, default=50.,
                        help="alpha0 parameter of the human model's trust dynamics (default: 50.)")

    parser.add_argument('--model-beta0', type=float, default=50.,
                        help="beta0 parameter of the human model's trust dynamics (default: 50.)")

    parser.add_argument('--model-ws', type=float, default=20.,
                        help="ws parameter of the human model's trust dynamics (default: 20.)")

    parser.add_argument('--model-wf', type=float, default=30.,
                        help="wf parameter of the human model's trust dynamics (default: 30.)")
...
def add_estimator_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--estimator-stepsize', type=float, default=0.005,
                        help='learning rate of the gradient descent algorithm (default: 0.005)')
